"""All locations tied to Madam Butterqwark, grouped into a CaseLocations bundle by which options.py toggle (if any) gates each part -- see locations/__init__.py for how these get merged/re-derived for regions.py."""
...
_CASE_NAME = SACCases.MADAM_BUTTERQWARK
...
MADAM_BUTTERQWARK_LOCATIONS = CaseLocations(_always_on, _mission, _all_missions, _cutscene, _other)
