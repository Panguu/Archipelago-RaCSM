...
class TitaniumBoltSlot:
    """Psp-backed accessor for the 5-byte cumulative bolt-pickup bitmask."""
...
class TitaniumBoltTotalSlot:
    """Psp-backed accessor for the single-byte cumulative bolt count."""
...
class TitaniumBoltInventory:
    """Psp-backed live accessor + completion tracking for titanium bolts,
