...
class ChallengeSlot:
    """Psp-backed accessor for a single challenge-completion byte at a fixed
...
class ChallengeInventory:
    """Psp-backed live accessor for every clank-challenge completion byte.
...
class SkyboardSlot:
    """Psp-backed accessor for a single skyboard race's completion bit.
...
class SkyboardInventory:
    """Psp-backed live accessor for every skyboard race's completion bit.
