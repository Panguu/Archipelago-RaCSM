...
class MenuStateSlot:
    """Psp-backed accessor for the current menu state byte."""
...
class MenuUpdateSlot:
    """Psp-backed accessor for the menu-change-request byte (write-only in practice)."""
...
class MenuInventory:
    """Psp-backed live accessor for the current menu state, replacing MenuState.
