...
class SkinSlot:
    """Psp-backed accessor for one SkinStruct field (unlocked bitmask or equipped id)."""
...
class SkinInventory:
    """Psp-backed live accessor for the equipped/unlocked skin bytes, replacing SkinState."""
