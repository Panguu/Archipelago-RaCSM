...
def set_pokitaru_rules(world: RACSizeMatterWorld) -> None:
    ...
    if world.options.all_missions:
        world.set_rule(mw.get_location(Rac5CutsceneLocations.POKITARU_FIGHT, player), HasProjectileWeapon())

    world.set_rule(mw.get_location(Rac5TBolts.POKITARU_ZIPLINE, player), HasProjectileWeapon())
    world.set_rule(mw.get_location(Rac5TBolts.POKITARU_HUT, player), HasProjectileWeapon())
