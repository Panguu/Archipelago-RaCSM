...
LOCATIONS = (
    ...
    Rac5Locations(
        ...
        Completion("armour", "hyperborean", 16),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.RYLLUS,
        lambda world: True_(),
        Completion("events", C.Rac5Locations.RYLLUS_SPROUT),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.RYLLUS,
        lambda world: HasAll(Rac5Gadgets.HYPERSHOT, Rac5Gadgets.SPROUT_O_MATIC),
        Completion("missions", 0x088c1386, 8, 2),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.RYLLUS,
        lambda world: HasAll(Rac5Gadgets.HYPERSHOT, Rac5Gadgets.SPROUT_O_MATIC),
        Completion("missions", 0x088c1386, 16, 2),
        options=LocationOptions(requirements=(OptionFilter(AllMissions, (1,), "in"),)),
        categories=frozenset(("story_mission", "mission")),
        check_order=5,
        definition_order=70,
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.RYLLUS,
        lambda world: True_(),
        Completion("missions", 0x088c1386, 2, 2),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.RYLLUS,
        lambda world: True_(),
        Completion("missions", 0x088c1386, 1, 2),
        options=LocationOptions(requirements=(OptionFilter(AllCutscenes, (1,), "in"),)),
        categories=frozenset(("cutscene", "mission")),
        check_order=18,
        definition_order=95,
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.RYLLUS,
        lambda world: True_(),
        Completion("events", C.Rac5VendorLocations.RYLLUS_AGENTS),
    ...
    Rac5Locations(
        ...
        Completion("events", C.Rac5TitanVendorLocations.RYLLUS_AGENTS_TITAN),
