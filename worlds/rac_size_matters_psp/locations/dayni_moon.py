...
LOCATIONS = (
    Rac5Locations(
        ...
        Completion("bolt_bits", None, 268435456),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: True_(),
        Completion("skill_bits", None, 268435456),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: Has(Rac5Gadgets.SPROUT_O_MATIC) & HasProjectileWeapon(),
        Completion("skill_bits", None, 536870912),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: Has(Rac5Gadgets.SPROUT_O_MATIC) & HasProjectileWeapon(),
        Completion("skill_bits", None, 1073741824),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: Has(Rac5Gadgets.SPROUT_O_MATIC) & HasProjectileWeapon(),
        Completion("missions", 0x088c1392, 8, 8),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: Has(Rac5Gadgets.SPROUT_O_MATIC) & HasProjectileWeapon(),
        Completion("missions", 0x088c1392, 4, 8),
        options=LocationOptions(requirements=(OptionFilter(AllMissions, (1,), "in"),)),
        categories=frozenset(("story_mission", "mission")),
        check_order=12,
        definition_order=77,
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: Has(Rac5Gadgets.SPROUT_O_MATIC) & HasProjectileWeapon(),
        Completion("missions", 0x088c1392, 16, 8),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: Has(Rac5Gadgets.SPROUT_O_MATIC) & HasProjectileWeapon(),
        Completion("missions", 0x088c1392, 2, 8),
        options=LocationOptions(requirements=(OptionFilter(AllCutscenes, (1,), "in"),)),
        categories=frozenset(("cutscene", "mission")),
        check_order=30,
        definition_order=90,
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: True_(),
        Completion("events", C.Rac5VendorLocations.DAYNI_MOON_SHOCK),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: True_(),
        Completion("events", C.Rac5VendorLocations.DAYNI_MOON_MAP),
    ...
    Rac5Locations(
        ...
        Completion("events", C.Rac5TitanVendorLocations.DAYNI_MOON_MOOTATOR_TITAN),
    ...
    Rac5Locations(
        ...
        Completion("events", C.Rac5TitanVendorLocations.DAYNI_MOON_SHOCK_TITAN),
        options=LocationOptions(
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: True_(),
        Completion("challenges", 0x088c13bf, increasing=True),
        options=LocationOptions(
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: True_(),
        Completion("challenges", 0x088c13c4, increasing=True),
        options=LocationOptions(
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: True_(),
        Completion("challenges", 0x088c13b6, increasing=True),
        options=LocationOptions(
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: True_(),
        Completion("challenges", 0x088c13b7, increasing=True),
        options=LocationOptions(
            requirements=(OptionFilter(ClankChallenges, (2,), "in"),), challenge_group="Demolition Derby"
        ),
        categories=frozenset(("all_clank",)),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: True_(),
        Completion("challenges", 0x088c13b8, increasing=True),
        options=LocationOptions(
            requirements=(OptionFilter(ClankChallenges, (2,), "in"),), challenge_group="Demolition Derby"
        ),
        categories=frozenset(("all_clank",)),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: True_(),
        Completion("challenges", 0x088c13b9, increasing=True),
        options=LocationOptions(
            requirements=(OptionFilter(ClankChallenges, (2,), "in"),), challenge_group="Demolition Derby"
        ),
        categories=frozenset(("all_clank",)),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: True_(),
        Completion("challenges", 0x088c13ba, increasing=True),
        options=LocationOptions(
            requirements=(OptionFilter(ClankChallenges, (2,), "in"),), challenge_group="Demolition Derby"
        ),
        categories=frozenset(("all_clank",)),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: True_(),
        Completion("challenges", 0x088c13bb, increasing=True),
        options=LocationOptions(
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: True_(),
        Completion("challenges", 0x088c13bc, increasing=True),
        options=LocationOptions(
            requirements=(OptionFilter(ClankChallenges, (2,), "in"),), challenge_group="Gadgetbot Toss"
        ),
        categories=frozenset(("all_clank",)),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: True_(),
        Completion("challenges", 0x088c13bd, increasing=True),
        options=LocationOptions(
            requirements=(OptionFilter(ClankChallenges, (2,), "in"),), challenge_group="Gadgetbot Toss"
        ),
        categories=frozenset(("all_clank",)),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: True_(),
        Completion("challenges", 0x088c13be, increasing=True),
        options=LocationOptions(
            requirements=(OptionFilter(ClankChallenges, (2,), "in"),), challenge_group="Gadgetbot Toss"
        ),
        categories=frozenset(("all_clank",)),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: True_(),
        Completion("challenges", 0x088c13c0, increasing=True),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: True_(),
        Completion("challenges", 0x088c13c1, increasing=True),
        options=LocationOptions(requirements=(OptionFilter(ClankChallenges, (2,), "in"),), challenge_group="Gadgetbot"),
        categories=frozenset(("all_clank",)),
        check_order=27,
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: True_(),
        Completion("challenges", 0x088c13c2, increasing=True),
        options=LocationOptions(requirements=(OptionFilter(ClankChallenges, (2,), "in"),), challenge_group="Gadgetbot"),
        categories=frozenset(("all_clank",)),
        check_order=28,
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.DAYNI_MOON,
        lambda world: True_(),
        Completion("challenges", 0x088c13c3, increasing=True),
        options=LocationOptions(requirements=(OptionFilter(ClankChallenges, (2,), "in"),), challenge_group="Gadgetbot"),
        categories=frozenset(("all_clank",)),
        check_order=29,
    ...
    Rac5Locations(
        ...
        Completion("events", C.Rac5ShrinkRayGrindrail.DAYNI_MOON_TITANIUM_BOLT_ENTRANCE),
