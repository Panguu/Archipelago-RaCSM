...
LOCATIONS = (
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.QUODRONA,
        lambda world: True_(),
        Completion("missions", 0x088c1396, 1, 10),
        options=LocationOptions(requirements=(OptionFilter(AllCutscenes, (1,), "in"),)),
        categories=frozenset(("cutscene", "mission")),
        check_order=25,
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.QUODRONA,
        lambda world: True_(),
        Completion("events", C.Rac5VendorLocations.QUODRONA_LASER),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.QUODRONA,
        lambda world: True_(),
        Completion("events", C.Rac5ModVendorLocations.QUODRONA_AGENTS_LAUNCHER),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.QUODRONA,
        lambda world: True_(),
        Completion("events", C.Rac5ModVendorLocations.QUODRONA_SCORCHER_SPITFIRE),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.QUODRONA,
        lambda world: True_(),
        Completion("events", C.Rac5ModVendorLocations.QUODRONA_SNIPER_SPLIT),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.QUODRONA,
        lambda world: True_(),
        Completion("events", C.Rac5ModVendorLocations.QUODRONA_SHOCK_LOCK),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.QUODRONA,
        lambda world: True_(),
        Completion("events", C.Rac5ModVendorLocations.QUODRONA_SHOCK_AFTER),
        options=LocationOptions(weapon=C.Rac5Weapons.SHOCK_ROCKET),
        categories=frozenset(("weapon_mod_vendor",)),
        weapon="shock_rocket",
        mod_slot="mod_slot_one",
    ...
    Rac5Locations(
        ...
        Completion("events", C.Rac5ModVendorLocations.QUODRONA_STATIC_MIRAGE),
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.QUODRONA,
        lambda world: HasChallengeMode(world, 1),
        Completion("events", C.Rac5ModVendorLocations.QUODRONA_LASER_RICOCHET),
        options=LocationOptions(
    ...
    Rac5Locations(
        ...
        C.Rac5Planets.QUODRONA,
        lambda world: HasChallengeMode(world, 1),
        Completion("events", C.Rac5TitanVendorLocations.QUODRONA_LASER_TITAN),
        options=LocationOptions(
            requirements=(OptionFilter(ChallengeMode, (1, 2), "in"),), weapon=C.Rac5Weapons.LASER_TRACER
        ),
    ...
    Rac5Locations(
        ...
        Completion("events", C.Rac5ShrinkRayGrindrail.QUODRONA_ENTRANCE),
