"""Nanotech location names, shared with the PS2 generation rules.

The PSP runtime detects levels from PlayerInventory.max_health. Experience
multiplication requires a separately verified PSP EXP counter.
"""
